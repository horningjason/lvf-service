"""Stub: LoST getServiceBoundary — returns notFound (RFC 5222 §12)."""
...
def build_response(server_uri: str = "lostserver.example.com") -> bytes:
    """Return a <errors><notFound> response — getServiceBoundary not yet implemented."""
    ...
    nf.set("message", "getServiceBoundary is not implemented on this LVF")
