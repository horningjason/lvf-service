...
`LVF_Algorithm_Specification_v74.docx`, and this codebase is a normative implementation of that
...
`LVF_Algorithm_Specification_v74.docx` (in this repository) is the authoritative description of
